...
def main(args=None):
    ...
    # Create the model
    image_size = (360, 640)
    retinanet = Retinanet(backbone, num_anchors=9, num_classes=validation_generator.num_classes(), feature_size=256, image_size=image_size)
